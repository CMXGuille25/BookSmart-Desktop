        ...
        <div className="usuario-editar-content-row">
          <div className="usuario-editar-card" style={{ height: '580px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%' }}>
              ...
              <button className="usuario-finalizar-registro-btn">Finalizar registro</button>
            </div>
          </div>
            ...
            <div className="usuario-registrar-cuadro-pequeno usuario-registrar-cuadro-pequeno-primero">
              ...
              <div className="usuario-registrar-cuadro-marron">
                <svg xmlns="http://www.w3.org/2000/svg" width="79" height="79" viewBox="0 0 79 79" fill="none">
                  <path d="M23.0415 59V46.5C23.0415 42.634 26.1755 39.5 30.0415 39.5H48.9582C52.8242 39.5 55.9582 42.634 55.9582 46.5V59" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                  <path d="M39.5 39.5C44.9538 39.5 49.375 35.1348 49.375 29.75C49.375 24.3652 44.9538 20 39.5 20C34.0462 20 29.625 24.3652 29.625 29.75C29.625 35.1348 34.0462 39.5 39.5 39.5Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M69.125 10.85V68.15C69.125 68.4814 68.8564 68.75 68.525 68.75H10.475C10.1436 68.75 9.875 68.4814 9.875 68.15V10.85C9.875 10.5186 10.1436 10.25 10.475 10.25H68.525C68.8564 10.25 69.125 10.5186 69.125 10.85Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <button className="usuario-registrar-btn">Registrar</button>
            </div>
            <div className="usuario-registrar-cuadro-pequeno usuario-registrar-cuadro-pequeno-segundo">
              ...
              <div className="usuario-registrar-cuadro-marron">
                <svg xmlns="http://www.w3.org/2000/svg" width="79" height="81" viewBox="0 0 79 81" fill="none">
                    <path d="M23.0415 53.8332V38.3717C23.0415 36.6725 23.3715 35.0413 23.978 33.5256M55.9582 53.8332V43.2179M30.3563 26.2814C32.9715 24.7351 36.1165 23.8333 39.4998 23.8333C47.0032 23.8333 53.3338 28.2686 55.3149 34.3333" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M32.9165 57.1666V49.9117M46.0832 57.1666V40.0097C46.0832 36.5986 43.1357 33.8333 39.4998 33.8333C35.864 33.8333 32.9165 36.5986 32.9165 40.0097V42.6568" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M19.75 10.5H9.875V20.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M59.25 10.5H69.125V20.5" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M19.75 70.5H9.875V60.5" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M59.25 70.5H69.125V60.5" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <button className="usuario-registrar-btn">Registrar</button>
            </div>
